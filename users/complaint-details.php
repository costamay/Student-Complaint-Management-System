    ...
    <section id="container">
        ...
        <section id="main-content">
            <section class="wrapper site-min-height">
                ...
                <div class="row mt">
                    <label class="col-sm-2 col-sm-2 control-label"><b>School :</b></label>
                    <div class="col-sm-4">
                ...
                <div class="row mt">
                    ...
                    <label class="col-sm-2 col-sm-2 control-label"><b>Residence :</b></label>
                    <div class="col-sm-4">
                        <p><?php echo htmlentities($row['residence']);?></p>
                    </div>
                </div>
