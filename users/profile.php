...
$query=mysqli_query($con,"update users set fullName='$fname',residenceName='$residence' where userEmail='".$_SESSION['login']."'");
if($query)
{
                    ...
                    <div class="col-lg-12">
                      ...
                      {?>
                            ...
                            <form class="form-horizontal style-form" method="post" name="profile">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">Residence</label>
                                    <div class="col-sm-4">
                                        <select name="residence" required="required" class="form-control">
                                            <option value="<?php echo htmlentities($row['residenceName']);?>">
                                                <?php echo htmlentities($st=$row['residenceName']);?></option>
                                            <?php $sql=mysqli_query($con,"select residenceName from residence ");
                                            while ($rw=mysqli_fetch_array($sql)) {
                                              if($rw['residenceName']==$st)
                                              {
                                                continue;
                                              }
                                              else
                                              {
                                              ?>
                                            <option value="<?php echo htmlentities($rw['residenceName']);?>">
                                                <?php echo htmlentities($rw['residenceName']);?></option>
                                            <?php
                                            }}
                                            ?>
