...
if($num>0)
{
	mysqli_query($con,"update users set password='$password' WHERE userEmail='$email'");
...
<body>
    <div id="login-page">
        <div class="container">
            ...
            <form class="form-login animate__animated animate__rotateInUpLeft" name="login" method="post">
                ...
                <div class="login-wrap">
                    <input type="text" class="form-control" name="username" placeholder="Email/User ID" required
