...
$query=mysqli_query($con,"insert into tblcomplaints(userId,category,subcategory,complaintType,residence,noc,complaintDetails,complaintFile) values('$uid','$category','$subcat','$complaintype','$residence','$noc','$complaintdetials','$compfile')");
