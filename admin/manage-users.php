...
<head>
    ...
    <title>Admin| Manage Sudents</title>
...
?>
                                        <tr>
                                            ...
                                            <td><a href="javascript:void(0);"
                                                    onClick="popUpWindow('http://localhost/students_complaint_management_system/admin/userprofile.php?uid=<?php echo htmlentities($row['id']);?>');"
                                                    title="View Details">
