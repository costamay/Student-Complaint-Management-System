                            ...
                            <div class="module-body table">
                                <table cellpadding="0" cellspacing="0" border="0"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><b>Residence </b></td>
                                            <td><?php echo htmlentities($row['residence']);?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:void(0);"
                                                    onClick="popUpWindow('http://localhost/students_complaint_management_system/admin/updatecomplaint.php?cid=<?php echo htmlentities($row['complaintNumber']);?>');"
                                                    title="Update order">
                                            ...
                                            <td colspan="4">
                                                <a href="javascript:void(0);"
                                                    onClick="popUpWindow('http://localhost/students_complaint_management_system/admin/userprofile.php?uid=<?php echo htmlentities($row['userId']);?>');"
                                                    title="Update order">
                                                    <button type="button" class="btn btn-danger">View User
                                                        Detials</button></a>
                                            </td>
